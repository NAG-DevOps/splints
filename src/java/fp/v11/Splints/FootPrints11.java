    ...
    public Object linkIssues() {
        ...
        try {
         ...
         props.put( "http.proxyPort", Config.PROXY_PORT );
            ...
            // Compose SOAP body.
            SOAPBody body = env.getBody();
            SOAPElement invoke = body.addChildElement(env.createName("MRWebServices__linkIssues", "namesp1", "MRWebServices"));
