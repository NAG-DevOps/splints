 ...
 */
@WebService(serviceName = "FootPrints11")
public class FootPrints11 implements ISplints {
    ...
    public String createIssue(@WebParam(name = "content") ContentMap params) {
        ...
        String ticketNumber = content.getString("id");
        try {
            ...
            arg4_1.addTextNode((String) content.get(Constants.PRIORITY_NUMBER));
            ...
            arg4_2.addTextNode((String) content.get(Constants.ISSUE_STATUS));
            ...
            arg4_4.addTextNode((String) content.get(Constants.DESCRIPTION));
            ...
            arg4_5_1.addTextNode((String) content.get(Constants.ASSIGNEES));
            ...
            arg4_3_4.addTextNode((String) content.get(Constants.CONTACT_EMAIL));
            ...
            arg4_7.addTextNode((String) content.get(Constants.WORKSPACE));
            ...
            arg4_8.addTextNode((String) content.get(Constants.ISSUE_SUBJECT));
...
//        }
    ...
    public void editIssue(ContentMap params) {
        ...
        try {
            ...
            arg4_3.addTextNode((String) content.get(Constants.ISSUE_SUBJECT));
            ...
            arg4_4.addTextNode((String) content.get(Constants.WORKSPACE));
            ...
            arg4_5.addTextNode((String) content.get(Constants.ISSUE));
