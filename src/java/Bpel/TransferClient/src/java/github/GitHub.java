/**
 * Simple JSON reader parser client (GET) for GitHub Usage:
 * https://bitbucket.org/soen487-w18-03/soen487-w18-team03/issues/8/github-json-parser
 */
package github;
...
public class GitHub implements ISplints {
    ...
    @Override
    public void editIssue(ContentMap inputParams) {
        JSONObject content = new JSONObject(inputParams.getMap());
        URL base;
        URL url = null;
        try {
            base = new URL(Config.API);
    ...
    /**
     * This method should later be merged into an utility package containing all
     * HTTP requests This method send a HTTP GET request to the given URL
     *
     * @param url
     */
