...
private ISplints fp12
    ...
    public String getIssue(@PathParam("issueNumber") int issueNumber) {
        ...
        Map<String,Serializable> issueDetails = fp12.getIssueDetails(content);
