...
public class bitbucketSearch {
	 ...
	 * @throws Exception
	 */
	public static void getIssueDetails(int issueNumber, String query) throws Exception {
		...
		try {
			...
			json = new JSONObject(getText(url)); //Gets the text request from URL
			// System.out.println(response);

			//Get the JSON data and put it in an array
			String[] names = JSONObject.getNames(json);

			//Show JSON results according to query
